...
public class LawOneController extends LawSceneController{
	...
	private final double SIZE_UNIT = 20;
	...
	private void setupCameraFirstPane() {
		Rectangle clip = new Rectangle(0,0, 500, 200); 
		//todo: replace width, height of pane
		
		//clip.x = circle.x
		clip.xProperty().bind(circle_object1.getView().layoutXProperty());
	...
	private void initFirstPane() {
        ...
        f = new Force(0, 0, circle_object1);
	...
	private void initSecondPane() {
        ...
        for (int i = 0; i < numBlocks * SIZE_UNIT; i+= SIZE_UNIT/2) {
	...
	public void lawOneSpeedUp(ActionEvent e){
		...
		f = new Force(5, 0, circle_object1);
		f.start();	
