...
public class ScrollAndClipBackground extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        //bind clip width to scene width
        //bind clip height to scene height
        clip.widthProperty().bind(scene.widthProperty());
        clip.heightProperty().bind(scene.heightProperty());

        //DEBUG: get width of this pane
        System.out.println(pane.getWidth());
        System.out.println(clip.getWidth());
        
        //bind clip x to player.x and scene.width - clip move same direction as player
        //bind clip y to player.y and scene.height
        //clip x,y changes => trigger pane.translateX,Y bind
        ...
        //bind pane translateX to clip.x * -1 - pane move opposite direction to player
        //bind pane translateY to clip.y * -1
        ...
        AnimationTimer timer = new AnimationTimer() {
            ...
            public void handle(long now) {
                ...
                if (up) deltaY -= speed ;
                //player coordinate changes => trigger clip.x,y bind
                ...
                //System.out.println("Clip: (" + clip.getX() + "," + clip.getY() + ")");
                //System.out.println("Pane tranlate: (" + pane.getTranslateX() + "," + pane.getTranslateY() + ")");
            }
        };
    ...
    /**
     * Return closest number to value in [min,max]
     * @param value
     * @param min
     * @param max
     * @return
